...
class viewMainWindow(tk.Tk):
    def __init__(self, controller):
        ...
        self.labelNumarIntrari = ttk.Label(self.frameIntrariNumar, text='Numarul de intrari:')
        ...
        self.labelFunctiaDeIntrare = ttk.Label(self.frameFunctiaDeIntrare, text='Functia de intrare')
        ...
        self.labelFunctiaDeActivare = ttk.Label(self.frameFunctiaDeActivare, text='Functia de activare')
        ...
        self.labelAlfa = tk.Label(self.frameAlfa, text='Alfa:', height=1, width=3)
        ...
        self.labelFunctiaDeIesire = ttk.Label(self.frameFunctiaDeIesire, text='Functia de iesire')
        ...
        self.entryBinarFunctiaDeIesire = tk.Checkbutton(self.frameFunctiaDeIesire, text='Binar', variable = self.valoareBinar, onvalue='true', offvalue='false')
